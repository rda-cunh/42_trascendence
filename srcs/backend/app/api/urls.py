...
urlpatterns = [
        ...
        # notification paths
        path("notifications/",                      notification_list.as_view()),
        path("notifications/unread-count/",         notification_unread_count.as_view()),
        path("notifications/read/",                 notification_mark_read.as_view()),
        path("notifications/read-all/",             notification_mark_all_read.as_view()),
