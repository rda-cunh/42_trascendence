...
STRIPE_SUCCESS_REDIRECT = os.getenv("STRIPE_SUCCESS_REDIRECT", "https://127.0.0.1/orders")
STRIPE_FAIL_REDIRECT   = os.getenv("STRIPE_FAIL_REDIRECT", "https://127.0.0.1/checkout")
