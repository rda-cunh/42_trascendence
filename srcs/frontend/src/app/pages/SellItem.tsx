...
export function SellItem() {
  ...
  const categories = [
    "3D Models", "2D Assets", "Shaders", "Textures", "VFX", "Audio", "UI/UX", "Scripts", "Other",
  ];

  const conditions = ["New", "Like New", "Excellent", "Good"];

  const engines = [
    "Unity", "Unreal Engine", "Godot", "GameMaker", "Any Engine", "Other",
  ];
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400">Share your creation with the game dev community</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl p-6 shadow-sm border border-gray-200 dark:border-gray-800 transition-colors space-y-4">
            ...
            <div>
              <label htmlFor="title" className="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                <Tag className="w-4 h-4" /> Asset Title *
              </label>
              <input
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="price" className="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
              ...
              <div>
                <label htmlFor="category" className="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label htmlFor="fileFormat" className="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  <FileText className="w-4 h-4" /> File Format *
                </label>
                <input
                  type="text" id="fileFormat" name="fileFormat" required
                  value={formData.fileFormat} onChange={handleChange}
                  placeholder="e.g., FBX, PNG, Shader Graph"
                  className="w-full px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-colors"
                />
              </div>
              <div>
                <label htmlFor="engine" className="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  <Package className="w-4 h-4" /> Compatible Engine *
                </label>
                <select
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="flex-1 px-6 py-3 bg-purple-600 text-white rounded-lg hover:bg-purple-700 disabled:opacity-50 transition-colors"
            >
